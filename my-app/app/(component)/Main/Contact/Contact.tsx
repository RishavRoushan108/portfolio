      ...
      <div className="w-[90%] md:w-[80%] lg:w-[70%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        <div>
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-200">
            Schedule a call with me to see i can help
          </h1>
          <p className="text-gray-400 mt-6 text-base sm:text-lg">
            reach out to me today and lets discuss how can i help you achive
            your goal
          </p>
          <div className="mt-7">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <p className="text-xl font-bold text-gray-400">
                rishavroushan98@gmail.com
              </p>
            </div>
            <div className="flex items-center space-x-3 mb-4">
              <BiPhone className="w-9 h-9 text-cyan-300" />
              <p className="text-xl font-bold text-gray-400">8235111576</p>
            </div>
            <div className="flex items-center space-x-3 mb-4">
          ...
          <div className="flex items-center mt-8 space-x-3">
            ...
            <div className="w-14 h-14 bg-blue-950/60 rounded-full flex items-center justify-center cursor-pointer flex-col hover:bg-pink-400 transition-all duration-300">
        ...
        <div className="px-4 py-3.5 bg-[#131332] rounded-lg">
          ...
          <textarea
            ...
            className="px-4 py-3.5 mt-6 h-40 bg-[#363659] text-white outline-none rounded-md w-full placeholder:text-white/70"
          ></textarea>
